...
/**
 * This file is part of the Zest Framework (Routing system) => http://zest.readthedocs.io/en/latest/ .
 *
...
class ZestRouter
{
     ...
     *
     * @param string $namespace  namepsace
     *
     * @return void
     */	
    ...
    {
        (!array_key_exists('namespace', $this->params)) ? $namespace = $this->namespace : $namespace .= $this->params['namespace'].'\\';
        return $namespace;
    }
